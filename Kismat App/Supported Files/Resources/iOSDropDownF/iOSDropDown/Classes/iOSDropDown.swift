...
open class DropDownTF: UITextField {
    ...
    public var padding = UIEdgeInsets(top: 0, left: 10, bottom: 0, right: 10)
    
    var dynamicPadding: UIEdgeInsets {
        get {
            return padding
        }
        set {
    ...
    public func updatePadding(top: CGFloat, left: CGFloat, bottom: CGFloat, right: CGFloat) {
        self.dynamicPadding = UIEdgeInsets(top: top, left: left, bottom: bottom, right: right)
    }
...
extension DropDownTF: UITableViewDataSource {
...
extension DropDownTF: UITableViewDelegate {
